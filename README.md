...
* **Analyse Cardio :** Visualisation des minutes passées en zones Aérobie, Seuil et Maximum.
* **Analyse Aérobie :** Suivi des zones Basse Aérobie, Haute Aérobie et Anaérobie.
* **Analyse Cadence :** Graphique coloré (heatmap) de la cadence (pas par minute/spm) au fil du temps.
